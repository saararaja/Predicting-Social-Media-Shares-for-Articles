...
![](Project-2-Template_files/figure-markdown_github/Var_Explore5-1.png)![](Project-2-Template_files/figure-markdown_github/Var_Explore5-2.png)
...
![](Project-2-Template_files/figure-markdown_github/Lin2-1.png)
...
Quadratic did not work
    ...
    ## Call:
    ## lm(formula = shares ~ data_channel_is_entertainment + kw_min_min + 
    ##     I(kw_min_min^2) + kw_max_max + I(kw_max_max^2) + kw_avg_max + 
    ##     I(kw_avg_max^2) + kw_max_avg + I(kw_max_avg^2) + kw_avg_avg + 
    ##     I(kw_avg_avg^2), data = dTrain)
    ## 
    ## Residuals:
    ##    Min     1Q Median     3Q    Max 
    ## -21234  -2793  -1447    -48 680310 
    ## 
    ## Coefficients:
    ##                                 Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)                    9.543e+02  1.253e+03   0.762  0.44637    
    ## data_channel_is_entertainment -1.096e+03  5.092e+02  -2.152  0.03142 *  
    ## kw_min_min                    -1.394e+01  6.357e+01  -0.219  0.82649    
    ## I(kw_min_min^2)               -4.041e-03  2.854e-01  -0.014  0.98870    
    ## kw_max_max                     3.101e-04  5.246e-03   0.059  0.95286    
    ## I(kw_max_max^2)               -5.973e-09  5.683e-09  -1.051  0.29335    
    ## kw_avg_max                     7.896e-04  7.680e-03   0.103  0.91811    
    ## I(kw_avg_max^2)               -8.858e-09  1.057e-08  -0.838  0.40196    
    ## kw_max_avg                    -2.523e-01  7.964e-02  -3.168  0.00155 ** 
    ## I(kw_max_avg^2)                2.153e-08  4.394e-07   0.049  0.96093    
    ## kw_avg_avg                     2.907e+00  4.126e-01   7.045 2.12e-12 ***
    ## I(kw_avg_avg^2)               -1.847e-05  2.559e-05  -0.722  0.47039    
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 13680 on 4650 degrees of freedom
    ## Multiple R-squared:  0.02508,    Adjusted R-squared:  0.02277 
    ## F-statistic: 10.87 on 11 and 4650 DF,  p-value: < 2.2e-16

![](Project-2-Template_files/figure-markdown_github/Leverage-1.png)
...
![](Project-2-Template_files/figure-markdown_github/Leverage-2.png)![](Project-2-Template_files/figure-markdown_github/Leverage-3.png)![](Project-2-Template_files/figure-markdown_github/Leverage-4.png)![](Project-2-Template_files/figure-markdown_github/Leverage-5.png)

### Non-Linear Model

Here I will fit a Random Forest
